...
BASE_OUTPUT_DIR="/home/arch/gem5_files/part_3/spechmmer/"

# Ensure the base directory exists
mkdir -p "$BASE_OUTPUT_DIR" || { echo "Failed to create base output directory."; exit 1; }
...
MAPPING_FILE="simulation_mapping_spechmmer.txt"
                ...
                for L1D_ASSOC in "${L1_ASSOCS[@]}"; do
                 for CACHE_LINE in "${CACHE_LINES[@]}"; do
                    ...
                    /home/arch/Desktop/gem5/build/ARM/gem5.opt \
                        ...
                        --cpu-clock=1GHz \
                        -c  /home/arch/spec_cpu2006/456.hmmer/src/spechmmer \
                        -o "--fixed 0 --mean 325 --num 45000 --sd 200 --seed 0 /home/arch/spec_cpu2006/456.hmmer/data/bombesin.hmm" \
                        -I 1000000 || { echo "Simulation failed for folder $OUTPUT_DIR"; exit 1; }
