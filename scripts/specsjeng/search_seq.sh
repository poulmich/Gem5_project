...
BASE_OUTPUT_DIR="/home/arch/gem5_files/part_3/test/specsjeng/"
...
run_simulation() {
    ...
    $CMD \
        ...
        -c /home/arch/spec_cpu2006/458.sjeng/src/specsjeng \
        -o "/home/arch/spec_cpu2006/458.sjeng/data/test.txt"\
        -I 1000000
}
